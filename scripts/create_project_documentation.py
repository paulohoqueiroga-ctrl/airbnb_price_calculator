...
def main():
    summary = json.loads((OUT / "project_summary.json").read_text(encoding="utf-8"))
...
"""
    ...
    (DOCS / "project_documentation.md").write_text(text.strip() + "\n", encoding="utf-8")
    print(DOCS / "project_documentation.md")
